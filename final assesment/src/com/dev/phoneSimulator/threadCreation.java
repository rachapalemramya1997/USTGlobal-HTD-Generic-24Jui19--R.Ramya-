...
public class threadCreation extends Thread {
	...
	static ContactData co = new ContactData();

	static Contacts ramya = co.createContact("ramya",8967543, "family");
	static Contacts mahi = co.createContact("mahi", 949567, "friends");
	static Contacts reddy = co.createContact("reddy", 949567, "college");
